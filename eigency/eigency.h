...
EIGENCY_MAKE_TYPEDEFS_ALL_SIZES(long long, ll)
EIGENCY_MAKE_TYPEDEFS_ALL_SIZES(unsigned long long, ull)
...
EIGENCY_MAKE_ARRAY_TYPEDEFS_ALL_SIZES(long long, ll)
EIGENCY_MAKE_ARRAY_TYPEDEFS_ALL_SIZES(unsigned long long, ull)
